...
import type { FkConfigurationWithUnits } from '~analyst-ui/components/azimuth-slowness/types';
...
import type { FkConfigurationPopoverProps, FkConfigurationPopoverState } from './types';
import { FkConfigurationPopoverPanel } from './types';

/**
 * FkConfigurationPopover component.
 */
export class FkConfigurationPopover extends React.Component<
  FkConfigurationPopoverProps,
  FkConfigurationPopoverState
> {
  ...
  public render(): JSX.Element {
    return (
      <div className="continous-fk-popover">
        <div className="form__header">FK Configuration</div>
        ...
        <div className="continous-fk-popover-apply-cancel-row">
          <Button
            text="Apply"
