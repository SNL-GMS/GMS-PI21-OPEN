        ...
        featureMeasurements: [
          {
            channel: {
              name:
                'ASAR.beam.BHZ/beam,fk,coherent/steer,az_90.142deg,slow_7.122s_per_deg/06c0cb24-ab8f-3853-941d-bdf5e73a51b4',
              effectiveAt: 1636503404
            },
            measuredChannelSegment: {
              id: {
        ...
        featureMeasurements: [
          {
            channel: {
              name:
                'ASAR.beam.BHN/beam,fk,coherent/steer,az_90.142deg,slow_7.122s_per_deg/06c0cb24-ab8f-3853-941d-bdf5e73a51b4',
              effectiveAt: 1636503404
            },
            measuredChannelSegment: {
              id: {
...
export const uiChannelSegment: UiChannelSegment = {
  ...
  channelSegment: {
    channelName: 'ASAR',
    wfFilterId: WaveformTypes.UNFILTERED,
    isSelected: false,
    description: 'unfiltered channel segment',
    ...
    dataSegments: [
      {
        ...
        data: {
          ...
          sampleRate: 20,
          id: '89b02661-24a7-43fd-84db-719f4c797184',
          values: [
            989239908,
            -1086337329,
            -1086045820,
...
// Use waveform data cache util in UI-State to populate cache
export const uiChannelSegmentData: Record<string, Record<string, UiChannelSegment[]>> = produce(
  {},
  createRecipeToMutateUiChannelSegmentsRecord(uiChannelSegment.channelSegment.channelName, [
    uiChannelSegment
  ])
);

export const asarFkbSegmentId = {
  channel: {
    name:
      'ASAR.beam.SHZ/beam,fk,coherent/steer,az_90.142deg,slow_7.122s_per_deg/06c0cb24-ab8f-3853-941d-bdf5e73a51b4',
    effectiveAt: 1636503404
