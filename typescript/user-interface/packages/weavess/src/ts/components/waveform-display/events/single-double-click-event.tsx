...
export class SingleDoubleClickEvent {
   ...
   */
  private shouldFireSingleClickEvent = true;
  ...
  public readonly onDoubleClick = (
    ...
    this.doubleClickDelayTimerId = delay(
      ...
      SingleDoubleClickEvent.DOUBLE_CLICK_TIMEOUT_MS,
      event
    );
  };
  ...
  public readonly onSingleClickEvent = (
    ...
    this.singleClickDelayTimerId = delay(
      ...
      // create a new event to ensure that the event is in scope for the delayed action
      SingleDoubleClickEvent.SINGLE_CLICK_DELAY_MS,
      event
    );
  };
}
