...
class ValidationTests {
  ...
  void testInputString() {
    String inputString = "\u0009This is an artificial log message";
    String cleansedString = Validation.cleanseInputString(inputString);
    assertEquals(-1, cleansedString.indexOf('\u0009'));
  }
}
