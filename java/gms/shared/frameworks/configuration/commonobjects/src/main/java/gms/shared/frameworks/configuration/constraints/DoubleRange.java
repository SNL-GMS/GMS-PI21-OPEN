...
public abstract class DoubleRange {
   ...
   *
   * @param min minimum bound, must be less than or equal to maximum
   * @param max maximum bound, must be greater than or equal to minimum
   * @return {@link DoubleRange}, not null
   * @throws IllegalArgumentException if maximum less than minimum
   */
  @JsonCreator
   ...
   * @return true if min less than or equal to val less than or equal to max; false otherwise
   */
