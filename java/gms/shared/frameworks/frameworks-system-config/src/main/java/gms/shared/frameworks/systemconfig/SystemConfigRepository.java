...
public interface SystemConfigRepository {
   ...
   *
   * <p>If the given key <i>already</i> includes a component name, then ignore our internal component
   * name and just decompose the given key into a list of search keys. For example, if the specified
   * key is 'timeinhibitor.port' and our component name is 'spacemodulator', this will return
   * ['timeinhibitor.port', 'port']. For this case, our internal component name is irrelevant since
   * they key already includes the component name the caller wants..
   *
