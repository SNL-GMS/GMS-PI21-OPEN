...
public interface FeaturePredictionCorrectionVisitor {
   ...
   */
  FeaturePredictionComponent computeCorrection(ElevationCorrection1dDefinition correction)
    throws IOException;
   ...
   * @throws IOException if unable to load 1D earth models
   */
  FeaturePredictionComponent computeCorrection(EllipticityCorrection1dDefinition correction)
    throws IOException;
