...
public class ParameterValidation {
  ...
  private static final Logger logger = LoggerFactory.getLogger(ParameterValidation.class);
   ...
   * @param exceptionMessage Message to log and throw in the event the object is invalid.
   * @param <T> Any class whose object needs to be validated.
   * @param <U> The type of the second input to be validated
   */
   ...
   * @param exceptionMessage Message to log and throw in the event the object is invalid.
   * @param <T> Any class whose object needs to be validated.
   * @param <U> The class of the second object to be validated
   */
