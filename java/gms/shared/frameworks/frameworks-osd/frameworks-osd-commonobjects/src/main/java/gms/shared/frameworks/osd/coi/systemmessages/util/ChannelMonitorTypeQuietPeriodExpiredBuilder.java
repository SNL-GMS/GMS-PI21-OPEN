 ...
 */
public class ChannelMonitorTypeQuietPeriodExpiredBuilder {

  private final String stationName;
  private final String channelName;
  private final SohMonitorType sohMonitorType;

  public ChannelMonitorTypeQuietPeriodExpiredBuilder(String stationName, String channelName,
  ...
  public SystemMessage build() {
    SystemMessageType type = SystemMessageType.CHANNEL_MONITOR_TYPE_QUIET_PERIOD_EXPIRED;
