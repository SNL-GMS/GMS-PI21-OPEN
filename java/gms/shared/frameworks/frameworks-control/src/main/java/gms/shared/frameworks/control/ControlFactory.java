...
public class ControlFactory {
   ...
   * Component}.  The controlClass instance is created by invoking the public static factory operation
   ...
   * controlClass.  The service will be stopped when the application's JVM shuts down.
   *
