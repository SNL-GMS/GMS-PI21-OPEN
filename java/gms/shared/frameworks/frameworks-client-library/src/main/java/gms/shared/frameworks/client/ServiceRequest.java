...
public abstract class ServiceRequest {
  ...
  public static ServiceRequest from(
    ...
    Type responseType, ContentType requestFormat, ContentType responseFormat) {
  ...
  public static Builder builder(URL url, Object body,
    Duration timeout, Type responseType) {
  ...
  public abstract static class Builder {
    ...
    public abstract Builder setResponseType(Type responseType);
