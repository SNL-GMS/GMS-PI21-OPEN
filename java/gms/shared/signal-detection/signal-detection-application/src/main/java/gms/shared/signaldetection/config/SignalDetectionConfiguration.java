...
@Configuration
@ComponentScan(basePackages = {"gms.shared.spring", "gms.shared.stationdefinition", "gms.shared.waveform",
  "gms.shared.emf"},
...
public class SignalDetectionConfiguration {
  ...
  private static final CacheInfo CHANNEL_SEGMENT_DESCRIPTOR_WFID_CACHE = new CacheInfo("channel-segment-descriptor-wfid-cache",
