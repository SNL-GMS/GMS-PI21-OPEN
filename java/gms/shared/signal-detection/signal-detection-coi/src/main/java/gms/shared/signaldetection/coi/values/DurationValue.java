...
public abstract class DurationValue {
  ...
  /**
   * The standard deviation of the value - can be null
   *
  ...
  public static DurationValue from(
    ...
    @JsonProperty("standardDeviation") @Nullable Duration standardDeviation) {
    return new AutoValue_DurationValue(value, Optional.ofNullable(standardDeviation));
  }
}
