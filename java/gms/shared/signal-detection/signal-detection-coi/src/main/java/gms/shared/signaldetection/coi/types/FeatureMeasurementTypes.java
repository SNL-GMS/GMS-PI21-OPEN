...
public class FeatureMeasurementTypes {
  ...
  public static final ArrivalTimeMeasurementType ARRIVAL_TIME = ArrivalTimeMeasurementType
  ...
  public static final FirstMotionMeasurementType SHORT_PERIOD_FIRST_MOTION = FirstMotionMeasurementType
    .from(Names.SHORT_PERIOD_FIRST_MOTION);

  public static final FirstMotionMeasurementType LONG_PERIOD_FIRST_MOTION = FirstMotionMeasurementType
    .from(Names.LONG_PERIOD_FIRST_MOTION);
