...
/**
 * Request body class for the WorkflowManager.updateInteractiveAnalysisStageIntervalStatus() endpoint
 */
@AutoValue
...
public abstract class UpdateInteractiveAnalysisStageIntervalStatusRequest implements UserRequest {
  ...
  /**
   * Gets the {@link IntervalStatus} to apply to the specified {@link gms.shared.workflow.coi.StageInterval}
   *
   * @return The {@link IntervalStatus} to apply to the specified {@link gms.shared.workflow.coi.StageInterval}
   */
  ...
  public abstract static class Builder {
    ...
    /**
     * Builds and returns a new UpdateInteractiveAnalysisStageIntervalStatusRequest with the set values
     *
