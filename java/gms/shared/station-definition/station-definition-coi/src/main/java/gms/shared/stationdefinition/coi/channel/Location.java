...
public abstract class Location implements Serializable {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(this.getDepthKm(), this.getElevationKm(), this.getLatitudeDegrees(), this.getLongitudeDegrees());
  ...
  public boolean equals(Object obj) {
    ...
    return (this.getDepthKm() == location.getDepthKm() &&
      this.getElevationKm() == location.getElevationKm() &&
      this.getLatitudeDegrees() == location.getLatitudeDegrees() &&
      this.getLongitudeDegrees() == location.getLongitudeDegrees());
  }
}
