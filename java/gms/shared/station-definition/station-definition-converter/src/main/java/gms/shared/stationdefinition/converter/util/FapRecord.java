...
/**
 * Represents a temporary version of a FAP (frequency, amplitude, phase) record. These are rows
 * in response files whose directory path and file name are specified in the instrument table.
 */
