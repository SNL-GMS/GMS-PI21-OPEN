...
@PositionalRecord
public class SensorRecordCss30 extends SensorRecord {
  protected static int recordLength = 139;
  ...
  @Override
  @PositionalField(initialPosition = 114, finalPosition = 119)
  ...
  @Override
  @PositionalField(initialPosition = 121, finalPosition = 121)
  ...
  @Override
  @PositionalField(initialPosition = 123, finalPosition = 139)
