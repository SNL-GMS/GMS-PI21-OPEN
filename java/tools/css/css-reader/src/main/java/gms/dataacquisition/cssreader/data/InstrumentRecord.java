...
public class InstrumentRecord {
  ...
  public void setInid(String s) {
    this.inid = Integer.valueOf(s);
  }
  ...
  public void setInsname(String s) {
    this.insname = s;
  }
  ...
  public String getDigitial() {
    return this.digitial;
  }

  public void setDigitial(String s) {
    this.digitial = s;
  }
  ...
  public void setNcalib(String s) {
    this.ncalib = Double.valueOf(s);
  }
  ...
  public void setNcalper(String s) {
    this.ncalper = Double.valueOf(s);
  }
  ...
  public void setRsptype(String s) {
    this.rsptype = s;
  }
  ...
  public void setLddate(String s) {
    this.lddate = CssReaderUtility.parseDate(s).orElse(null);
  }
